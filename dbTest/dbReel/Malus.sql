...
--
-- Hôte : localhost
-- Généré le : lun. 19 avr. 2021 à 08:12
...
--
-- Structure de la table `malus_complet`
--

CREATE TABLE `malus_complet` (
  `Id_malus` int(250) DEFAULT NULL,
  `Designation` varchar(20) DEFAULT NULL,
  `Id_zone` int(250) DEFAULT NULL,
  `montant_vente` int(15) DEFAULT NULL,
  `valeur_malus` int(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Structure de la table `malus_complet_avec_zone`
--

CREATE TABLE `malus_complet_avec_zone` (
  `Id_malus` int(250) DEFAULT NULL,
  `Designation` varchar(20) DEFAULT NULL,
  `Id_zone` int(250) DEFAULT NULL,
  `montant_vente` int(15) DEFAULT NULL,
  `valeur_malus` int(15) DEFAULT NULL,
  `zone_designiation` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
